...
//    SEL setServerslecter = NSSelectorFromString(@"setDefuatServerURL:");
//    if ([callClass respondsToSelector:setServerslecter]) {
//        IMP imp = [callClass methodForSelector:setServerslecter];
//        void (*func)(id, SEL, NSString *, void(^)(void)) = (void *)imp;
//        func(callClass, setServerslecter, @"https://jitsi.rtctest.7moor.com", closeAction);
//    }
//
